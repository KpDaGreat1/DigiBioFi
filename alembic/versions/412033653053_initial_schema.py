...
Revision ID: 412033653053
Revises: 
Create Date: 2026-04-03 01:04:46.635633
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_custom_sections_profile_id'), 'custom_sections', ['profile_id'], unique=False)
    ...
    op.create_index(op.f('ix_profile_views_visitor_hash'), 'profile_views', ['visitor_hash'], unique=False)
